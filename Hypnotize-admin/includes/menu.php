...
print '<strong>[</strong> <a href="'.htmlspecialchars($_SERVER["PHP_SELF"], ENT_QUOTES, 'ISO-8859-1').'?site=edit&amp;id2='.$id.'" class="menu">'.$sitename.'</a> <strong>]</strong> ';
//else if $link2 is empty and $lbreak is 1 then
}elseif(empty($link2) && $lbreak =="1"){
//print out the menu item and add a break at the end
print '<strong>[</strong> <a href="'.htmlspecialchars($_SERVER["PHP_SELF"], ENT_QUOTES, 'ISO-8859-1').'?site=edit&amp;id2='.$id.'" class="menu">'.$sitename.'</a> <strong>]</strong><br>';
